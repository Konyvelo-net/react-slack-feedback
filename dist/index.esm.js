...
`;t.div`
  margin-bottom: 0.5em;
`;var O={fontFamily:'-apple-system, BlinkMacSystemFont, Arial, Arial Unicode, "Helvetica Neue", Helvetica, "Hiragino Sans GB", "Microsoft YaHei", SimSun, sans-serif',colors:{border:"#d0d8e1",primary:"#0088ff",secondary:"#222c4f",background:"#f4f4f7",success:"#3dc86f",error:"#ec3c3c",text:"#333333"},content:{width:"380px",padding:"0.6em",borderRadius:"4px",fontSize:"14px",fontWeight:500,boxShadow:`0 6px 30px 2px ${u("#222c4f",.3)}`},header:{color:"white",fontWeight:400,backgroundColor:"#222c4f"},loader:{color:"#ffffff",size:"4em",width:"3px"},button:{fontWeight:500,boxShadow:`0 2px 8px 2px ${u("#0087ff",.2)}`,opacity:.8},trigger:{color:"#ffffff",hoverColor:"#ffffff",backgroundColor:"#222c4f",border:"none",padding:"12px 1.25em",borderRadius:"6px",fontSize:"14px",fontWeight:"400",boxShadow:"0 3px 12px 1px rgba(34, 44, 79, 0.1)",hoverBoxShadow:"0 6px 16px 2px rgba(0, 0, 0, 0.2)",hoverBackgroundColor:"inherit"},input:{backgroundColor:"white",padding:"0.5em",color:"#444444",fontSize:"14px",borderRadius:"4px",border:"1px solid #d0d8e1",boxShadow:`0 0 8px ${u("#0087ff",.3)}`},label:{color:"#222c4f",fontSize:"12px"},tab:{color:"#333333",selectedColor:"white",selectedBackgroundColor:"#0087ff",border:"1px solid #d0d8e1",borderRadius:"4px",backgroundColor:"rgba(255, 255, 255, 0.5)"},image:{height:"140px",borderRadius:"4px",border:"1px solid #d0d8e1"},uploadButton:{color:"#333333",hoverColor:"#333333",backgroundColor:"white",hoverBackgroundColor:"rgba(255, 255, 255, 0.6)",border:"1px solid #d0d8e1"},overlay:{backgroundColor:u("#222c4f",.4)}};const A="bug",R="improvement",F="feature";class M extends e.Component{constructor(t){super(t),n(this,"translate",e=>{const{translations:t}=this.props;return"object"==typeof t&&e in t?t[e]:c[e]||""}),n(this,"handleChange",e=>t=>this.setState({[e]:t.target.value})),n(this,"toggle",()=>{this.state.open?this.close():this.activate()}),n(this,"activate",()=>{this.setState(({open:e})=>({open:!e}),this.props.onOpen),document.addEventListener("click",this.handleClickOutside)}),n(this,"handleClickOutside",e=>{e.defaultPrevented||this.SlackFeedback&&this.SlackFeedback.current&&!this.SlackFeedback.current.contains(e.target)&&this.close()}),n(this,"close",()=>{this.setState({open:!1},()=>{this.props.onClose()}),document.removeEventListener("click",this.handleClickOutside)}),n(this,"selectType",e=>()=>this.setState({selectedType:e})),n(this,"resetSentState",()=>{this.setState({message:""},()=>{setTimeout(()=>{this.setState({sent:!1})},this.props.sentTimeout)})}),n(this,"onSubmitSuccess",()=>{this.setState({sending:!1,sent:!0,image:{},error:!1},()=>this.resetSentState())}),n(this,"onSubmitError",e=>this.setState({sending:!1,error:this.determineErrorType(e)},()=>{setTimeout(()=>{this.setState({error:null})},this.props.errorTimeout)})),n(this,"determineErrorType",e=>{if(!e)return this.translate("error.unexpected");if("string"==typeof e)return e;switch(e.status){case 400:return this.translate("error.badrequest");case 403:return this.translate("error.forbidden");case 404:return this.translate("error.notfound");case 410:return this.translate("error.archived");case 500:return this.translate("error.internal");default:return this.translate("error.unexpected")}}),n(this,"send",()=>{const{selectedType:e,image:t}=this.state;let r="warning";switch(this.setState({sending:!0}),e){case A:r="danger";break;case F:r="good";break;case R:default:r="warning"}const o={attachments:[{fallback:`Feedback (${e})`,author_name:this.props.user,color:r,title:e,title_link:document.location.href,text:this.state.message,footer:this.translate("footer.text")}]};t.url&&(o.attachments[0].image_url=t.url),this.props.onSubmit(o,this.onSubmitSuccess.bind(this),this.onSubmitError.bind(this))}),n(this,"attachImage",e=>{const{files:t}=e.target,r=t[0];r.preview=window.URL.createObjectURL(r),this.setState({image:r,uploadingImage:!0},()=>{this.props.onImageUpload(r,this.onImageUploadSuccess.bind(this),this.onImageUploadError.bind(this))})}),n(this,"onImageUploadError",e=>{let t=this.translate("error.upload");e&&"string"==typeof e&&(t=e),this.setState({uploadingImage:!1,error:t},()=>{this.removeImage(),setTimeout(()=>{this.setState({error:null})},this.props.errorTimeout)})}),n(this,"onImageUploadSuccess",e=>{if("string"!=typeof e)return console.error("[SlackFeedback] `url` argument in `imageUploaded` method must be a string"),void this.removeImage();this.setState(({image:t})=>({uploadingImage:!1,image:{...t,url:e}}))}),n(this,"removeImage",e=>{e&&e.preventDefault(),this.setState({image:{},uploadingImage:!1})}),n(this,"renderImagePreview",()=>{const{image:t={},uploadingImage:r}=this.state;return t.preview?e.createElement(T,{style:{backgroundImage:`url(${t.preview})`}},r?e.createElement(y,null):e.createElement(j,null,e.createElement("span",{onClick:this.removeImage},this.translate("image.remove")))):null}),this.state={open:t.open,sending:!1,sent:!1,error:!1,uploadingImage:!1,selectedType:t.defaultSelectedType||this.props.feedbackTypes[0].value,image:{},message:""},this.SlackFeedback=e.createRef()}render(){if(this.props.disabled)return null;const{open:t,sending:r,sent:o,error:n,selectedType:i,uploadingImage:s}=this.state,{channel:c}=this.props,p=this.props.icon,u=Boolean(c)&&this.props.showChannel;let h=this.translate("submit.text");o&&(h=this.translate("submit.sent")),r&&!o&&(h=this.translate("submit.sending")),n&&(h=n);const g=d(O,this.props.theme);return e.createElement(a,{theme:g},e.createElement(v,{ref:this.SlackFeedback,className:l({active:t})},e.createElement(k,{className:l("fadeInUp",{active:t})},e.createElement(w,null,this.props.showIcon?e.createElement(p,null):null," ",this.translate("header.title"),e.createElement($,{className:"close",onClick:this.close},this.translate("close"))),e.createElement(S,null,u&&e.createElement("span",{id:"channel"},e.createElement(z,{htmlFor:"channel"},this.translate("label.channel")),e.createElement(I,{disabled:!0,as:"input",value:this.props.channel})),e.createElement(z,null,this.translate("label.type")),e.createElement(E,null,this.props.feedbackTypes.map(t=>e.createElement("li",{key:t.value,className:l({selected:i===t.value}),title:t.label,onClick:this.selectType(t.value)},t.label))),e.createElement(z,null,this.translate("label.message")),e.createElement(I,{as:"textarea",name:"message",value:this.state.message,placeholder:this.translate("placeholder"),onChange:this.handleChange("message")}),e.createElement(B,{disabled:r||s||!this.state.message,className:l({sent:o,error:n}),onClick:this.send},h))),e.createElement(C,{className:l({active:t}),onClick:this.toggle},this.props.showIcon?e.createElement(p,null):null," ",this.translate("trigger.text"))))}}M.defaultProps={channel:"",defaultSelectedType:null,disabled:!1,errorTimeout:8e3,feedbackTypes:[{value:A,label:c["feedback.type.bug"]},{value:R,label:c["feedback.type.improvement"]},{value:F,label:c["feedback.type.feature"]}],icon:()=>e.createElement(p,null),onClose:()=>{},onOpen:()=>{},open:!1,sentTimeout:5e3,showChannel:!0,showIcon:!0,theme:O,translations:c,user:"Anonymous"},M.defaultTheme=O,M.SlackIcon=p;var N=Object.freeze({__proto__:null,dark:{colors:{primary:"#3579f5",secondary:"black",background:"black"},content:{padding:"0 0.75em 1em",width:"400px"},trigger:{color:"white",hoverColor:"black",backgroundColor:"black",hoverBackgroundColor:"white",border:"none",padding:"8px 8px",borderRadius:"6px",fontSize:"14px"},input:{backgroundColor:"rgba(255, 255, 255, 0.15)",padding:"1em",color:"white",fontSize:"14px",borderRadius:"4px",border:"none"},label:{fontSize:"12px"},tab:{color:"rgba(255, 255, 255, 0.8)",border:"none",borderRadius:"4px",padding:"1em",backgroundColor:"rgba(255, 255, 255, 0.15)"},uploadButton:{color:"white",hoverColor:"white",border:"none",hoverBorder:"none",backgroundColor:"#222",hoverBackgroundColor:"#323232"},image:{border:"none"}}});export default M;export{N as themes};
